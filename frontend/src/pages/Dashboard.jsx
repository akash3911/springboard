                        ...
                        {notifications.length > 0 ? (
                            <div className="space-y-2.5">
                                {notifications.map((n) => (
                                    <div
                                        key={n.id}
                                        className={`p-3 rounded-lg border text-xs transition-all ${n.isRead || n.read ? 'bg-gray-50 border-gray-100 opacity-75' : 'bg-blue-50/40 border-blue-200 font-medium'
                                            }`}
                                    >
